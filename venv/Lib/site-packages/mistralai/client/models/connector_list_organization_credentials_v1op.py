...
class ConnectorListOrganizationCredentialsV1RequestTypedDict(TypedDict):
    connector_id_or_name: str
    auth_type: NotRequired[Nullable[OutboundAuthenticationType]]
    fetch_default: NotRequired[bool]


class ConnectorListOrganizationCredentialsV1Request(BaseModel):
