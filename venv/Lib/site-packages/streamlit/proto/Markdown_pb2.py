...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_MARKDOWN']._serialized_end=251
  _globals['_MARKDOWN_TYPE']._serialized_start=163
  _globals['_MARKDOWN_TYPE']._serialized_end=245
